...
describe("ThreadMessages", () => {
  ...
  it("separates a turn from the next prompt with role-aware rhythm", () => {
    const messages: UIMessage[] = [
      { id: "u1", role: "user", content: "Check the project.", createdAt: 1 },
      {
        id: "r1",
        role: "assistant",
        content: "",
      ...
      { id: "a1", role: "assistant", content: "The project is ready.", createdAt: 4 },
      { id: "u2", role: "user", content: "Now summarize it.", createdAt: 5 },
    ];
    ...
    expect(rows[2]).toHaveClass("mt-4");
    expect(rows[3]).toHaveClass("mt-7");
  });
