...
const LOCALIZED_SETTINGS_COPY_KEYS = [
  ...
  "settings.sections.customInstructions",
  ...
  "settings.rows.customInstructions",
  ...
  "settings.archived.search",
  "settings.archived.allProjects",
  "settings.archived.noProjectChats",
  "settings.archived.deleteAll",
  "settings.archived.deleteProject",
  "settings.archived.deleteConfirm",
  "settings.archived.empty",
  "settings.archived.emptyFiltered",
  "settings.archived.confirmDescription",
];
